...
I love that with a single keyboard shortcut (`Option+Space` for me), Superwhisper will immediately start recording, and with another stroke it will transcribe and paste it right where your cursor is.

Also great: being able to set up custom modes with specific instructions on how to transcribe the recordings.