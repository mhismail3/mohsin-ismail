...
I just shipped version 2.0.0 of [Moose Tabs](https://chromewebstore.google.com/detail/moose-tabs-organize-your/ecgdnamlhfodmjokjobadclppaddeond), my Chrome extension for organizing tabs into a hierarchical tree view.
...
For the full technical breakdown of the v2.0.0 updates, as well as details on the v1.0.0 foundation, check out the [Moose Tabs project page](/portfolio/moose-tabs).
